...
// in simulator we redefine to format for MyNewApp Developer console
...
#define DEFINE_EXCEPTIONS                                                                                      \
  ...
  {                                                                                                            \
    NSString *exceptionName = [@"org.mynewapp." stringByAppendingString:NSStringFromClass([self class])];  \
    TiExceptionThrowWithNameAndReason(exceptionName, reason, subreason, location);                             \
  }                                                                                                            \
                                                                                                               \
  +(void)throwException : (NSString *)reason subreason : (NSString *)subreason location : (NSString *)location \
  {                                                                                                            \
    NSString *exceptionName = @"org.mynewapp";                                                             \
    TiExceptionThrowWithNameAndReason(exceptionName, reason, subreason, location);                             \
  }
...
enum {
  UIMyNewAppNativeItemNone = -1,
  UIMyNewAppNativeItemSpinner = -2,
  UIMyNewAppNativeItemProgressBar = -3,

  UIMyNewAppNativeItemSlider = -4,
  UIMyNewAppNativeItemSwitch = -5,
  UIMyNewAppNativeItemMultiButton = -6,
  UIMyNewAppNativeItemSegmented = -7,

  UIMyNewAppNativeItemTextView = -8,
  UIMyNewAppNativeItemTextField = -9,
  UIMyNewAppNativeItemSearchBar = -10,

  UIMyNewAppNativeItemPicker = -11,
  UIMyNewAppNativeItemDatePicker = -12,

  UIMyNewAppNativeItemInfoLight = -13,
  UIMyNewAppNativeItemInfoDark = -14,

  UIMyNewAppNativeItemDisclosure = -15,

  UIMyNewAppNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all MyNewApp instances of
