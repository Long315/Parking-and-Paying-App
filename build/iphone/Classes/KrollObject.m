...
//@interface MyNewAppObject : NSObject
//@end

@interface MyNewAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
  ...
  if (o) {
    ...
    if ([o isKindOfClass:[MyNewAppObject class]]) {
      for (NSString *key in [[(MyNewAppObject *)o modules] allKeys]) {
