 ...
 * to send analytic data that can be viewed on the MyNewApp Dashboard.
 *
 * For information on getting started with MyNewApp Platform Services,
 * see [MyNewApp Platform Services for iOS](http://bit.ly/1kqteQS).
 */
