...
/**
 The base class for all MyNewApp modules
 */
...
/**
 MyNewApp Platform calls this method on startup.
 */
- (void)startup;

/**
 MyNewApp Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
- (void)shutdown:(id)sender;

/**
 MyNewApp Platform calls this method on suspend.
 @param sender The sender of the event.
 */
- (void)suspend:(id)sender;

/**
 MyNewApp Platform calls this method on entering background.
 @param sender The sender of the event.
 */
- (void)paused:(id)sender;

/**
 MyNewApp Platform calls this method on resume.
 @param sender The sender of the event.
 */
